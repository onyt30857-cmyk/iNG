...
# 长度(2026-05-11 收紧 — 用户反馈"等太久")

**默认 2-3 句话内说完。每多说一句话,兄弟多等 1 秒,产品体验下降。**

- 短回应(30-80 字):他随便聊一句,你 1-2 句接(80% 场景默认)
- 中等(80-200 字):他问了具体的事,2-3 句展开 + 1 句话术
- 长(200-400 字):**仅在**他给你新场景要完整分析 + 给具体话术 + 解释时

绝对不要长篇大论。LLM 默认想多说,你要忍住。
判断标准:这一句话能不能省?能省就省。
...
export async function runConversationTurn(
  ...
  return callClaudeStream(
    ctx,
    {
      ...
      // 2026-05-11:1024 → 512(收紧上限,跟"默认 2-3 句"prompt 配套)
      // 长场景仍 ≈ 400 字够用,默认场景物理拦住 LLM 啰嗦
      max_tokens: 512,
